  ...
  return (
    <div className="absolute inset-0 z-10 grid place-items-center bg-background/72 backdrop-blur-md">
      <div className="w-full max-w-sm px-6 text-center">
        ...
        <p className="font-display text-xl font-semibold text-foreground">{t("studio.buildingFrame")}</p>
        <p className="mt-2 text-sm leading-6 text-muted">{t("studio.buildingFrameDesc")}</p>
