...
export const POST = createModeratedApiHandler<unknown, CampaignParams>(
  async ({ request }) => {
  ...
  { feature: "campaign_generator", rateLimit: { keyPrefix: "campaign.regenerate", limit: 10, windowMs: 60 * 1000 } },
);
